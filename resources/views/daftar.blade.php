        ...
        <div class="card-body">
          ...
          <form action="{{ route('register') }}" method="post">
            ...
            @enderror
              ...
              <div class="input-group mb-3">
                <select class="form-control @error('fungsional') is-invalid @enderror" id="fungsional" name="tipe" required>
                  <option value="">-Pilih Peran-</option>
                  @foreach ($tipeuser as $tipeuser => $value)
                  <option value="{{ $tipeuser }}">{{ $value }}</option>
                  @endforeach
                </select>
                @error('fungsional')
                <span class="invalid-feedback" role="alert">
