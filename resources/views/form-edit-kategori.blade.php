...
@if(auth()->user()->tipe_user_id=='2') 
        <title>Staff | Edit Kategori</title>
        @endif
@endsection
@section('sidebar')
          ...
          <div class="col-12">
            <div class="card">
                <div class="modal-content">
                    ...
                    <form action="/update-kategori{{ $kategori->id }}" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    @csrf
                                                    <div class="position-relative form-group">
                                                      <label>Nama</label>
                                                      <input name="nama_kategori" type="text" value="{{ $kategori->nama_kategori }}" class="form-control"  required>
